...
function novoHotel() {
    ...
    $hotel->setCafeIncluso($cafeIncluso == 1);
...
do {
    ...
    echo "       (2) Cancelar Espaço\n";
    echo "       (3) Listar Espaço\n";
    echo "       (0) Sair\n";
    echo "==========================\n";
        ...
        case 1:
            ...
            do {
                ...
                switch($tipo) {
                    ...
                    case 2:
                        array_push($espacos, novoPontoTuristico());
                        break;
