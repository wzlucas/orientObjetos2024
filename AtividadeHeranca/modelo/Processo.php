...
class Processo extends Documento {
    ...
    public function getDadosDoc() {
        ...
        if ($this->empenho !== null) {
            return "Processo: " . $dadosBase . " | Número do Processo: " . $this->numeroProcesso . " | Causa: " . $this->causa . " | Anexo: " . $this->anexo . " | Empenho: " . $this->empenho->getDadosDoc();
        }
        return "Processo: " . $dadosBase . " | Número do Processo: " . $this->numeroProcesso . " | Causa: " . $this->causa . " | Anexo: " . $this->anexo . " | Empenho: Não associado";
    }
